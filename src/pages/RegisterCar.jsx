...
export default function BeDriver() {
  return (
    <div className="relative w-full min-h-screen bg-black flex flex-col pt-8 pb-10 px-2 font-inter">
      ...
      <div className="flex flex-col items-center lg:flex-row justify-center gap-y-8 lg:gap-x-12 w-full max-w-6xl mx-auto mb-8">
          ...
          <div className="flex gap-2 mb-6 mt-1">
            {[...Array(6)].map((_, i) => (
              <input
                ...
                type="text"
                maxLength={1}
                className="w-12 h-14 bg-white rounded-md shadow text-center text-2xl font-semibold border-none outline-none"
                disabled
              />
            ))}
          </div>
        ...
        <div className="bg-[#D2D1BE] rounded-[20px] shadow-lg flex flex-col items-center py-6 px-3 w-[90vw] max-w-[410px] mx-auto">
          <Tittle size="semi" className="bg-[#FEF801] px-6 py-2 mb-2 mt-1 text-black">Foto de tu vehículo</Tittle>
          <div className="mb-4" />
          ...
          <Tittle size="semi" className="bg-[#FEF801] px-7 py-2 mb-2 text-black">Foto del SOAT</Tittle>
          <div className="mb-2" />
      ...
      <div className="w-full flex justify-center mt-2">
        <Button size="extraLarge">Registrar vehiculo</Button>
      </div>
    </div>
  );
}