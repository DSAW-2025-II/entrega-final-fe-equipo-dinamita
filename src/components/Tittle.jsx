...
const Tittle = ({
  ...
  const baseClasses =
    "font-bold rounded-full inline-block transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FEF801]";
  ...
  return (
    <p className={tittleClasses} {...props}>
      {children}
    </p>
  );
};
